...
immune.combined <- FindNeighbors(immune.combined, reduction = "pca", dims = 1:12)
immune.combined <- FindClusters(immune.combined, resolution = 0.2)
immune.combined <- RunUMAP(immune.combined, reduction = "pca", dims = 1:14,n.neighbours=500L, min.dist=0.2)
...
features <- c("MKI67", "KRT14", "KRTDAP", "FLG", "CDSN", "MLANA", "PTPRC", "CD207", "SELE", "LYVE1", "COL1A1", "S100B", "ACTA2")
